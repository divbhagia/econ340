...
topics["sampest"] = [
    "Sample mean distribution; Good estimators",
...
if sem == "spring":
    ...
    examday = "Thu 05/15"  # CHECK THIS DATE
...
df = pd.DataFrame(
    {"Date": dates, "Lecture": "", "Module": "", "Topics": "", "Due": ""},
    dtype="object",
)
...
# When is stuff due?
df.loc[df["Lecture"] == 6, "Due"] = "RP Team"
