...
Below, I elaborate on the expected [structure and content](#structure-and-content) of your paper, as well as instructions regarding [formatting and submission](#format-and-submission). You can also find the rubric that will be used for grading by clicking [here](final-rubric.html).

<!--  At the bottom of the page, you’ll also find a [rubric](#rubric) that will be used for grading. Finally, here are some [slides](final-submission-slides.pdf) that briefly go over the instructions provided below. -->
...
-   Cite sources using the APA (American Psychological Association) format and attach a reference list at the end of your write-up. Click [here](https://www.mendeley.com/guides/apa-citation-guide/) to learn more. 
...
Write down a References List using the [APA format](https://www.mendeley.com/guides/apa-citation-guide/), where you cite the papers you referenced in the Literature Review section.
