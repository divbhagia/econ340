...
<!-- At the bottom of the page, you'll also find a [rubric](#rubric) that will be used for grading.  -->

Finally, here is an [example submission](submission2-example.pdf) with it's corresponding [R code](submission2-example-code.R) to guide you. Please use this as a reference only; any sentences directly copied from the example submission will be considered plagiarism.  
