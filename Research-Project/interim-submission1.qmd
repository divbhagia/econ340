...
This submission marks the beginning of your research project. For this submission, you need to describe your research question and the data you will use. You should highlight why your question is interesting and important, mention the source of your data, and highlight the variables you will use. 

Before proceeding, please review the [Research Project Overview](research-project.qmd) page for detailed guidance on selecting your research question and data. Here is a brief summary of the key criteria to consider:
...
- In addition to your primary independent and dependent variables, you should identify **at least two control variables** that are plausibly correlated with both the primary independent and dependent variables. See the [section on variables](research-project.qmd#variables) on the [overview](research-project.qmd) page for more details. 
