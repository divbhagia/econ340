...
The key components of the syllabus are outlined below. You can access the complete syllabus in PDF format by clicking [here](Syllabus/Econ%20340%20Syllabus.pdf).
...
- Huntington-Klein, Nick. 2021. The Effect: An Introduction to Research Design and Causality. Boca Raton, Florida: Chapman and Hall / CRC. [https://theeffectbook.net/](https://theeffectbook.net/)
